...
def index():
    ...
    html = html.replace(
        "</head>",
        '<link rel="stylesheet" href="/static/css/experiments_ui.css?v=ui-refactor-5">\n'
        '<link rel="stylesheet" href="/static/css/ui_refactor.css?v=ui-refactor-5">\n'
        '<link rel="stylesheet" href="/static/css/ui_themes.css?v=ui-refactor-5">\n'
        '<link rel="stylesheet" href="/static/css/ui_sections.css?v=ui-refactor-5">\n'
        '<link rel="stylesheet" href="/static/css/ui_provider_cleanup.css?v=ui-refactor-5">\n</head>',
    )
    return html.replace(
        "</body>",
        '<script src="/static/js/experiments_ui.js?v=ui-refactor-5"></script>\n'
